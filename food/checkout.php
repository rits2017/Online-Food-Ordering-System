...
<form action="" method="post">
   ...
   <div class="cart-items">
      ...
      ?>
      <p><span class="name"><?= $fetch_cart['name']; ?></span><span class="price">NPR <?= $fetch_cart['price']; ?> x <?= $fetch_cart['quantity']; ?></span></p>
      <?php
            }
         }else{
      ...
      ?>
      <p class="grand-total"><span class="name">Grand Total :</span><span class="price">NPR <?= $grand_total; ?></span></p>
